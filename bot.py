...
class Dxbot(discord.Client):
    ...
    async def on_message(self, message):
        ...
        try:
            # If input is a number and channel is Benpai's testing channel,
            # or #dx-friend-codes channel
            if int(input) and (message.channel.id == 352449754573045763 or
                               message.channel.id == 670567133700161568):
                ...
                if intl is None and jp is None:
                    ...
                    embed = discord.Embed(color=0x51bcf3,
                                          title=type + ' profile for ' + profile['name'],
                                          url=friend_url)
